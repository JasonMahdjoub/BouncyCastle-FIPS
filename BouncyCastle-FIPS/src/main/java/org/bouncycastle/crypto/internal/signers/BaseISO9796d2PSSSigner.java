 ...
 */
public class BaseISO9796d2PSSSigner
    implements SignerWithRecovery
{
        ...
        CipherParameters param)
    {
        ...
        if (forSigning)
        {
            cipher.init(forSigning, new ParametersWithRandom(kParam, random));
        }
        else
        {
     ...
     * @see org.bouncycastle.crypto.internal.SignerWithRecovery#hasFullMessage()
     */
     ...
     * @see org.bouncycastle.crypto.internal.SignerWithRecovery#getRecoveredMessage()
     */

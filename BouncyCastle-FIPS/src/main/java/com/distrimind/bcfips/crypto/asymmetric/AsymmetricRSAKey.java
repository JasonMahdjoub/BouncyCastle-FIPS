 ...
 * setting the system property "com.distrimind.bcfips.rsa.allow_multi_use" to "true".
 * </p>
 */
    ...
    implements AsymmetricKey
{
     ...
     * the modulus is associated with a different usage already. The system property "com.distrimind.bcfips.rsa.allow_multi_use"
    ...
    {
        return Properties.isOverrideSet("com.distrimind.bcfips.rsa.allow_multi_use") || keyMarker.canBeUsed(usage);
    }

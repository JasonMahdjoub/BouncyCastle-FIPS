...
class Salsa20Engine
{
        ...
        ParametersWithIV     params)
    {
        ...
        */
        ...
        ParametersWithIV ivParams = params;
        ...
        KeyParameter keyParam = ivParams.getParameters();
        if (keyParam == null)
        {
            if (!initialised)
            {
    ...
    public byte returnByte(byte in)
    {
        if (limitExceeded())
        {
            throw new IllegalArgumentException("2^70 byte limit per IV; Change IV");
        }

...
public final class FipsTripleDES
{
       ...
       extends FipsParameters
   {
    ...
    private static ValidatedSymmetricKey validateKey(SymmetricKey key, com.distrimind.bcfips.crypto.Parameters parameters, boolean forReading)
    {
        ...
        if (!Properties.isOverrideSet("com.distrimind.bcfips.tripledes.allow_weak"))
        {
            if (!forReading)
            {

...
public final class FipsEC
{
        ...
        extends FipsAgreementFactory<MQVAgreementParameters>
    {
        ...
        {
            checkEnabled();
            if (Properties.isOverrideSet("com.distrimind.bcfips.ec.disable_mqv"))
            {
                throw new UnsupportedOperationException("EC MQV has been disabled by setting \"com.distrimind.bcfips.ec.disable_mqv\"");
            }
        }
    ...
    private static void checkEnabled()
    {
        ...
        {
            throw new UnsupportedOperationException("EC has been disabled by setting \"com.distrimind.bcfips.ec.disable\"");
        }
    }

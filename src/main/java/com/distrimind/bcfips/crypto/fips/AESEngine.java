...
{
    private static final KeyParameter ZERO_KEY = new KeyParameterImpl(new byte[16]);
...
private static final int[] Tinv0 =
    ...
    */
        ...
        int outOff)
    {
        ...
        if (forEncryption)
        {
            encryptBlock(in, inOff, WorkingKey, out, outOff);
        }
        else
        {
            decryptBlock(in, inOff, WorkingKey, out, outOff);
        }
    ...
    private void encryptBlock(byte[] input, int inOff, int[][] KW, byte[] out, int outOff)
    {
        int t0 = ((input[inOff++] & 0xff)
                  | ((input[inOff++] & 0xff) << 8)
                  | ((input[inOff++] & 0xff) << 16)
                  | (input[inOff++] << 24)) ^ KW[0][0];

        int t1 = ((input[inOff++] & 0xff)
                          | ((input[inOff++] & 0xff) << 8)
                          | ((input[inOff++] & 0xff) << 16)
                          | (input[inOff++] << 24)) ^ KW[0][1];

        int t2 = ((input[inOff++] & 0xff)
                          | ((input[inOff++] & 0xff) << 8)
                          | ((input[inOff++] & 0xff) << 16)
                          | (input[inOff++] << 24)) ^ KW[0][2];

        int r = 1, r0, r1, r2,
            r3 = ((input[inOff++] & 0xff)
                  | ((input[inOff++] & 0xff) << 8)
                  | ((input[inOff++] & 0xff) << 16)
                  | (input[inOff] << 24)) ^ KW[0][3];
    ...
    private void decryptBlock(byte[] input, int inOff, int[][] KW, byte[] out, int outOff)
    {
        int t0 = ((input[inOff++] & 0xff)
                  | ((input[inOff++] & 0xff) << 8)
                  | ((input[inOff++] & 0xff) << 16)
                  | (input[inOff++] << 24)) ^ KW[ROUNDS][0];

        int t1 = ((input[inOff++] & 0xff)
                          | ((input[inOff++] & 0xff) << 8)
                          | ((input[inOff++] & 0xff) << 16)
                          | (input[inOff++] << 24)) ^ KW[ROUNDS][1];
        
        int t2 = ((input[inOff++] & 0xff)
                          | ((input[inOff++] & 0xff) << 8)
                          | ((input[inOff++] & 0xff) << 16)
                          | (input[inOff++] << 24)) ^ KW[ROUNDS][2];

        int r = ROUNDS - 1, r0, r1, r2,
            r3 = ((input[inOff++] & 0xff)
                  | ((input[inOff++] & 0xff) << 8)
                  | ((input[inOff++] & 0xff) << 16)
                  | (input[inOff] << 24)) ^ KW[ROUNDS][3];
        ...
        packBlock(
            (Si[r0&255]&255) ^ ((s[(r3>>8)&255]&255)<<8) ^ ((s[(r2>>16)&255]&255)<<16) ^ (Si[(r1>>24)&255]<<24) ^ KW[0][0],
             (s[r1&255]&255) ^ ((s[(r0>>8)&255]&255)<<8) ^ ((Si[(r3>>16)&255]&255)<<16) ^ (s[(r2>>24)&255]<<24) ^ KW[0][1],
             (s[r2&255]&255) ^ ((Si[(r1>>8)&255]&255)<<8) ^ ((Si[(r0>>16)&255]&255)<<16) ^ (s[(r3>>24)&255]<<24) ^ KW[0][2],
             (Si[r3&255]&255) ^ ((s[(r2>>8)&255]&255)<<8) ^ ((s[(r1>>16)&255]&255)<<16) ^ (s[(r0>>24)&255]<<24) ^ KW[0][3],
        out, outOff);
    }

    ...
    implements Mac
{
     ...
     */
    public GMac(final AEADBlockCipher cipher)
    {
     ...
     *            the cipher to be used in GCM mode to generate the MAC.
     */
    public GMac(final AEADBlockCipher cipher, final int macSizeBits)
    {
        this.cipher = cipher;
    ...
    /**
     * Initialises the GMAC - requires a {@link ParametersWithIV} providing a {@link KeyParameterImpl}
     * and a nonce.
     */

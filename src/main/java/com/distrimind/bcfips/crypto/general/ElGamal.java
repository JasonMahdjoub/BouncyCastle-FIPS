...
public final class ElGamal
{
     ...
     */
    public interface WrapParameters extends com.distrimind.bcfips.crypto.Parameters
    {
    ...
    public static final class KeyWrapOperatorFactory
        implements com.distrimind.bcfips.crypto.KeyWrapOperatorFactory<WrapParameters, AsymmetricDHKey>
    {

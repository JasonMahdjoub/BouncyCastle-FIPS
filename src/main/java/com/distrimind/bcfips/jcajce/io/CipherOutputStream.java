package com.distrimind.bcfips.jcajce.io;
 ...
 * finalisation} are rethrown wrapped in an {@link InvalidCipherTextException}.
 */
    ...
    extends FilterOutputStream
{
     ...
     *
     * @throws java.io.IOException if an I/O error occurs.
     * @throws InvalidCipherTextException if the data written to this stream was invalid
        ...
        throws IOException
    {
        ...
        {
            error = new InvalidCipherTextException("Error during cipher finalisation", e);
        }
        catch (Exception e)
        {

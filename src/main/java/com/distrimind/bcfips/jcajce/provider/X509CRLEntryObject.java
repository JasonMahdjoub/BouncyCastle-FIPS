    ...
    extends X509CRLEntry
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (o instanceof X509CRLEntryObject)
        {
            ...
            if (this.isHashValueSet && other.isHashValueSet)
            {
                ...
                while (e.hasMoreElements())
                {
                    ...
                    if (ext.getExtnValue() != null)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                buf.append(CRLReason.getInstance(ASN1Enumerated.getInstance(obj))).append(nl);
                            }
                            else if (oid.equals(Extension.certificateIssuer))
                            {
                                buf.append("Certificate issuer: ").append(GeneralNames.getInstance(obj)).append(nl);
                            }
                            else 
                            {

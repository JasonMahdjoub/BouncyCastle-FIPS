...
class CertStoreCollectionSpi extends CertStoreSpi
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        {
            throw new InvalidAlgorithmParameterException("com.distrimind.bcfips.jcajce.provider.CertStoreCollectionSpi: parameter must be a CollectionCertStoreParameters object\n" +  params.toString());
        }

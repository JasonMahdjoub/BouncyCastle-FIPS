...
import com.distrimind.bcfips.math.field.FiniteFields;
...
public abstract class ECCurve
{
    ...
    public static abstract class AbstractF2m extends ECCurve
    {
        ...
        protected AbstractF2m(int m, int k1, int k2, int k3)
        {
            ...
            {
                throw new UnsupportedOperationException("F2M disabled by \"com.distrimind.bcfips.ec.disable\"");
            }
            if (Properties.isOverrideSet("com.distrimind.bcfips.ec.disable_f2m"))
            {
                throw new UnsupportedOperationException("F2M disabled by \"com.distrimind.bcfips.ec.disable_f2m\"");
            }
        }
